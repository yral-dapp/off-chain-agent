...
pub struct WrappedContext {
    ...
    rx: async_channel::Receiver<BusMessage>,
}
...
impl WrappedContext {
    pub fn new() -> anyhow::Result<Self> {
        ...
        let (tx, rx) = async_channel::unbounded::<BusMessage>();
        ...
        conn.reducers
            .on_add(move |event, hash, video_id, timestamp| {
                ...
                tx.send_blocking((search_hash, res)).unwrap();
            });
    ...
    pub async fn add(
        ...
        let res = loop {
            let (recv_hash, data) = self.rx.recv().await?;
