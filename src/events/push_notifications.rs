...
use yral_spacetime_bindings::autogenerated::backend::{LikedPayload, NotificationType, VideoUploadPayload};
...
pub async fn dispatch_notif(
    ...
    match event_type {
        ...
        "like_video" => {
            ...
            app_state.notification_store_ctx.add(params["principal"], notification_type).await?;
        }
        ...
        "video_upload_successful" => {
            ...
            app_state.notification_store_ctx.add(target_principal, notification_type).await?;
        }
        _ => {}
    }
    Ok(())
